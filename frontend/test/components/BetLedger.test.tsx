...
const summary = { wins: 2, losses: 1, pushes: 0, pending: 2 };
...
const bets: Bet[] = [
  {
    ...
    line: -2.5, american_odds: -105, description: null, status: 'won',
    created_at: '2026-06-09T12:00:00Z', settled_at: '2026-06-11T03:00:00Z',
  },
  {
  ...
  },
  {
    ...
    status: 'pending', created_at: '2026-06-09T14:00:00Z', settled_at: null,
  },
];
...
describe('BetLedger', () => {
  it('renders the record and pending stats', () => {
    render(
      <BetLedger
        bets={bets}
        summary={summary}
