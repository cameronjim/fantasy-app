...
// tailwind only emits classes it can see as literals, so the tier -> class map
// is spelled out rather than built with a template string.
const TIER_CLASS = {
...
/**
 * Horizontal percentile bars, one per category. Turnover percentiles arrive
 * already inverted from the server, so every bar here reads the same way:
