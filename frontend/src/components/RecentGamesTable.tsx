...
/**
 * Raw box scores behind the trend charts, newest first. There is no result
 * column: the analytics payload carries the player's line, not the team's, so
 * a W/L here would be a guess.
 */
