# Rolling-origin evaluation - 20260817c

- **generated_at**: 2026-08-17 19:00 UTC
...
## Feature-set comparison: v1 features vs v2 (teammate context)

Same dataset, same rows, same origins, same estimators. The only difference is whether the estimators were allowed to see the nine teammate-context columns. `delta` is after minus before, so **negative is better** for both Brier and MAE.

| task                | metric   | segment                      |      n |   before |   after |   delta | delta_pct   |
|:--------------------|:---------|:-----------------------------|-------:|---------:|--------:|--------:|:------------|
| A availability      | Brier    | ALL                          | 30,917 |   0.0734 |  0.071  | -0.0024 | -3.30%      |
| A availability      | Brier    | star (>=30)                  |  6,958 |   0.0667 |  0.0665 | -0.0003 | -0.40%      |
| A availability      | Brier    | starter (20-30)              |  9,940 |   0.0681 |  0.0671 | -0.001  | -1.43%      |
| A availability      | Brier    | bench (10-20)                |  8,177 |   0.068  |  0.0658 | -0.0022 | -3.28%      |
| A availability      | Brier    | fringe (<10)                 |  5,058 |   0.1075 |  0.0993 | -0.0082 | -7.59%      |
| A availability      | Brier    | unknown (no history)         |    784 |   0.0373 |  0.0327 | -0.0046 | -12.28%     |
| A availability      | Brier    | event: vacated_minutes >= 30 | 23,231 |   0.077  |  0.0748 | -0.0022 | -2.86%      |
| A availability      | Brier    | event: star_out = 1          |  7,219 |   0.0786 |  0.075  | -0.0036 | -4.52%      |
| A availability      | Brier    | control: vacated_minutes < 5 |    955 |   0.0595 |  0.0515 | -0.0081 | -13.55%     |
| B minutes|played    | MAE      | ALL                          | 21,853 |   4.7225 |  4.5365 | -0.186  | -3.94%      |
| B minutes|played    | MAE      | star (>=30)                  |  5,598 |   3.8301 |  3.814  | -0.0161 | -0.42%      |
| B minutes|played    | MAE      | starter (20-30)              |  7,823 |   4.6497 |  4.5539 | -0.0958 | -2.06%      |
| B minutes|played    | MAE      | bench (10-20)                |  5,995 |   5.5257 |  5.208  | -0.3178 | -5.75%      |
| B minutes|played    | MAE      | fringe (<10)                 |  2,411 |   5.0522 |  4.5308 | -0.5214 | -10.32%     |
| B minutes|played    | MAE      | unknown (no history)         |     26 |   5.715  |  4.1288 | -1.5861 | -27.75%     |
| B minutes|played    | MAE      | event: vacated_minutes >= 30 | 16,625 |   4.7565 |  4.5839 | -0.1726 | -3.63%      |
| B minutes|played    | MAE      | event: star_out = 1          |  5,196 |   5.1443 |  4.9234 | -0.2209 | -4.29%      |
| B minutes|played    | MAE      | control: vacated_minutes < 5 |    550 |   4.3619 |  4.2081 | -0.1538 | -3.53%      |
| D pts UNCONDITIONAL | MAE      | ALL                          | 30,917 |   3.9546 |  3.9112 | -0.0434 | -1.10%      |
| D pts UNCONDITIONAL | MAE      | star (>=30)                  |  6,958 |   6.3033 |  6.2868 | -0.0165 | -0.26%      |
| D pts UNCONDITIONAL | MAE      | starter (20-30)              |  9,940 |   4.5661 |  4.5325 | -0.0336 | -0.74%      |
| D pts UNCONDITIONAL | MAE      | bench (10-20)                |  8,177 |   3.1036 |  3.0455 | -0.0581 | -1.87%      |
| D pts UNCONDITIONAL | MAE      | fringe (<10)                 |  5,058 |   1.4489 |  1.3723 | -0.0766 | -5.29%      |
| D pts UNCONDITIONAL | MAE      | unknown (no history)         |    784 |   0.3373 |  0.2998 | -0.0375 | -11.11%     |
| D pts UNCONDITIONAL | MAE      | event: vacated_minutes >= 30 | 23,231 |   4.05   |  4.0249 | -0.0251 | -0.62%      |
| D pts UNCONDITIONAL | MAE      | event: star_out = 1          |  7,219 |   4.1522 |  4.1526 |  0.0004 | +0.01%      |
| D pts UNCONDITIONAL | MAE      | control: vacated_minutes < 5 |    955 |   3.0945 |  2.9696 | -0.125  | -4.04%      |
