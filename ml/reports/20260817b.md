# Rolling-origin evaluation - 20260817b

- **generated_at**: 2026-08-17 18:02 UTC
...
| D pts UNCONDITIONAL | composition  | MAE      | decomposed_p_x_minutes_x_ppm |           3.9546 | decomposed_p_x_minutes_x_ppm |             3.9546 | True             |
...
- champion `decomposed_p_x_minutes_x_ppm`: **3.9546** MAE
- previous `decomposed_p_x_ewma`: 4.0066 MAE
- relative delta: -1.30% (tolerance 1.00%) — **PARITY**
...
|                                                              |   O1 valid=2024-12 |   O2 valid=2025-01 |   O3 valid=2025-02 |   O4 valid=2025-12 |   O5 valid=2026-01 |   mean |
|:-------------------------------------------------------------|-------------------:|-------------------:|-------------------:|-------------------:|-------------------:|-------:|
| decomposed CHAMPION: P(play) x E[MIN|played] x EWMA[PTS/min] |             4.0121 |             3.8637 |             4.1184 |             3.9708 |             3.8078 | 3.9546 |
...
| decomposed (demoted): P(play) x EWMA[PTS|played]             |             4.0698 |             3.9082 |             4.1659 |             4.0333 |             3.8555 | 4.0066 |
...
| decomposed (demoted): P(play) x EWMA[PTS|played]             |             0.0901 |             0.1329 |             0.1535 |             0.1182 |             0.1205 |  0.1230 |
...
| decomposed CHAMPION: P(play) x E[MIN|played] x EWMA[PTS/min] |             0.1030 |             0.1428 |             0.1632 |             0.1319 |             0.1313 |  0.1344 |
...
|                                                              |   star (>=30) |   starter (20-30) |   bench (10-20) |   fringe (<10) |   unknown (no history) |
|:-------------------------------------------------------------|--------------:|------------------:|----------------:|---------------:|-----------------------:|
| decomposed (demoted): P(play) x EWMA[PTS|played]             |        6.3316 |            4.6065 |          3.1835 |         1.4540 |                 0.7558 |
| decomposed: P(play) x LightGBM[PTS|played]                   |        6.2771 |            4.5715 |          3.1546 |         1.5686 |                 0.2779 |
| decomposed CHAMPION: P(play) x E[MIN|played] x EWMA[PTS/min] |        6.3033 |            4.5661 |          3.1036 |         1.4489 |                 0.3373 |
